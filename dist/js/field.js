...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-nova-action-button', __webpack_require__(4));
  Vue.component('detail-nova-action-button', __webpack_require__(10));
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    closeConfirmationModal: function closeConfirmationModal() {
      ...
      this.errors = new __WEBPACK_IMPORTED_MODULE_0_laravel_nova__["Errors"]();
      this.loading = false;
    },
    ...
    executeAction: function executeAction() {
      ...
      Nova.request({
        ...
        if (error.response.status == 422) {
          _this.errors = new __WEBPACK_IMPORTED_MODULE_0_laravel_nova__["Errors"](error.response.data.errors);
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6ca9e6be", Component.options)
  } else {
    hotAPI.reload("data-v-6ca9e6be", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
      ...
      !_vm.hidden
        ? _c(
            "button",
            {
              ...
              style: "background-color: " + _vm.field.buttonColor,
              attrs: { disabled: _vm.disabled },
              on: { click: _vm.openConfirmationModal }
            },
            [
              _vm.showLoading
                ? _c("loading", { attrs: { color: _vm.field.loadingColor } })
